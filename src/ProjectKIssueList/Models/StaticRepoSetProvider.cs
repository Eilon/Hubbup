...
namespace ProjectKIssueList.Models
{
    ...
    {
        private static readonly Dictionary<string, RepoDefinition[]> RepoSetList = new Dictionary<string, RepoDefinition[]>(StringComparer.OrdinalIgnoreCase)
        {
            {
                "kcore",
                new RepoDefinition[] {
        ...
        public IDictionary<string, RepoDefinition[]> GetRepoSetLists()
        {
            return RepoSetList;
        }

        public RepoDefinition[] GetAllRepos()
        {
            return RepoSetList.SelectMany(repoSet => repoSet.Value).ToArray();
        }

        public RepoDefinition[] GetRepoSet(string repoSet)
        {
